      ...
      <div class="text-center py-8">
        ...
        <div class="grid grid-cols-2 gap-4 mt-6">
          <div class="text-center">
            ...
            <div class="text-lg font-semibold text-gray-900 dark:text-white">--°C</div>
          </div>
          <div class="text-center">
          ...
          <div class="text-center">
            ...
            <div class="text-lg font-semibold text-gray-900 dark:text-white">-- m/s</div>
          </div>
          <div class="text-center">
            <div class="text-sm text-gray-500 dark:text-gray-400">視界</div>
            <div class="text-lg font-semibold text-gray-900 dark:text-white">-- km</div>
          </div>
        </div>
      </div>
    </div>
